...
echo "On Windows, open DevRigorHookActivator-1.6.2.exe and approve the six exact hook hashes. On other Codex clients, use the client's supported hook review UI. Then restart Codex."
